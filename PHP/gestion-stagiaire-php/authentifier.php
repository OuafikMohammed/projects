<?php
session_start();
// Sessions allow you to store data across different pages and requests for the same user.
$loginError = '';
// This ensures that $loginError has a default value, preventing any undefined variable errors.
// $SESSION An associative array containing session variables available to the current script.
 ...
 <div class="flex flex-col h-screen bg-gradient-to-b from-[#063970] to-blue-200">
        <div class="grid place-items-center mx-2 my-20 sm:my-auto" x-data="{ showPass: true }">
            <div class="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12
                ...
                <!-- Verification.php nous envoi les donnees a authentifier.php grace a POST -->
                    <div>
